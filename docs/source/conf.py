...
# -*- coding: utf-8 -*-
#
# bigfloat documentation build configuration file, created by
# sphinx-quickstart on Sun Jun 29 15:53:52 2014.
#
...
latex_documents = [
  ('index', 'bigfloat.tex', 'bigfloat Documentation',
   'Mark Dickinson', 'manual'),
]
...
man_pages = [
    ('index', 'bigfloat', 'bigfloat Documentation',
     ['Mark Dickinson'], 1)
]
...
texinfo_documents = [
  ('index', 'bigfloat', 'bigfloat Documentation',
   'Mark Dickinson', 'bigfloat', 'One line description of project.',
   'Miscellaneous'),
]
