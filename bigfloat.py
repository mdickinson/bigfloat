...
class BigFloat(object):
    ...
    def hex(self):
        ...
        m = self._significand()
        _, digits, _ = mpfr_get_str2(m._value, 16, 0, 'RoundTiesToEven')
    ...
    def __str__(self):
        if is_zero(self):
            ...
            negative, digits, e = mpfr_get_str2(self._value, 10, 0,
                                                     'RoundTiesToEven')
    ...
    def _format_to_fixed_precision(self, precision):
        ...
        _, _, exp = mpfr_get_str2(self._value, 10, 2, 'RoundTowardZero')
